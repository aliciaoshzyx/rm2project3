...
const ExpenseForm = (props) => {
    return (
        ...
        >
            ...
            <input id="expenseName" type="text" name="expenseName" placeholder="McDonalds"/>
            <label htmlFor="expenseAmount">Amount Due: </label>
            <input id="expenseAmount" type="text" name="expenseAmount" placeholder="0.00"/>
            <label htmlFor="expenseIntensity">Intensity: </label>
            <select id="expenseIntensity" name="expenseIntensity">
            ...
            <label htmlFor="expenseDay">Day: </label>
            <select id="expenseDay" name="expenseDay">
            ...
            <label htmlFor="expenseYear">Year: </label>
            <select id="expenseYear" name="expenseYear">
    ...
    if(props.expenses.length === 0){
        return (
            <div className="expenseList">
                <h3 className="emptyExpense">No Entries Yet</h3>
            </div>
        );
    }
    ...
    const expenseNodes = props.expenses.map(function(expense) {
        return (
            <div key={expense._id} className="expense">
                <h3 className="expenseName">Name: {expense.name} </h3>
                <h3 className="expenseAmount">Amount: {expense.amount} </h3>
            </div>
        );
    });
